...
Results
(Fill in after running the pipeline on your machine — exact numbers depend on the specific train/test split and any random seed variance.)
...
Screenshots
(Add dashboard screenshots here once the app is running — e.g. Overview tab, Forecasting tab, Segmentation tab.)
...
Anurag	ML Pipeline	@Anurag678-coder	feature_engineering.py, forecasting.py, explainability.py, churn_prediction.py
